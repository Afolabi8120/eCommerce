                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table id="example" class="table table-striped table-bordered mt-3">
                        ...
                        <tbody>
                        <?php $i = 1; foreach($order->fetchUsersTransactions($getCustomer->id) as $fetchOrder): ?>
                          <tr>
                            <td><?= $i++; ?></td>
                            <td><a href="view-order/<?= $fetchOrder->invoiceno; ?>"><?= $fetchOrder->invoiceno; ?></a></td>
                            ...
                            <td><a href="print-receipt/<?= $fetchOrder->invoiceno; ?>"><i class="fa fa-print fa-2x"></i></a></td>
                          </tr>
                          <?php endforeach; ?>
                      </table>
                    </div>
